      ...
      >
        <div className="max-w-6xl mx-auto px-4 h-full flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <span className="font-heading font-bold text-xl text-zowee-light tracking-tight">
              ZOWEE
            </span>
        ...
        <div className="max-w-6xl mx-auto px-4 relative z-10 pb-24">
          ...
          <section className="pt-8 pb-6 animate-fade-in-up">
            <div className="flex items-center justify-between gap-4">
              <div>
                <h1 className="font-heading font-bold text-2xl text-zowee-light tracking-tight">
                  Company Dashboard
                </h1>
                <p className="text-sm mt-1 text-zowee-light/45">
                  Sales and customer tracking for Zowee
                </p>
              </div>
          ...
          >
            <div className="grid grid-cols-2 lg:grid-cols-3 gap-4">
              ...
              <div className="rounded-2xl p-5 bg-gradient-to-br from-white/3 to-white/1 border border-white/8">
                ...
                <p className="font-heading font-bold text-3xl text-zowee-light tracking-tight leading-none">
                  {stats.totalSignups}
                </p>
              ...
              <div className="rounded-2xl p-5 bg-gradient-to-br from-zowee-green/5 to-zowee-green/2 border border-zowee-green/20">
                ...
                <p className="font-heading font-bold text-3xl text-zowee-green tracking-tight leading-none">
                  {stats.activeUsers}
                </p>
                <p className="text-xs font-semibold mt-1.5 text-zowee-light/65">
                  Active Subscribers
                </p>
