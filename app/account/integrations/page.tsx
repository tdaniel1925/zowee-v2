      ...
      <div className="min-h-screen bg-zowee-dark pt-[60px]">
        <div className="max-w-3xl mx-auto px-4 relative z-10 py-12">
            ...
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                <div className="flex items-center gap-3 mb-2">
                  <h3 className="font-heading font-bold text-lg text-zowee-light">
                    Amazon Alexa
                  </h3>
                  {alexaLinked && (
                    <span className="text-xs font-semibold px-2 py-0.5 rounded-lg bg-zowee-green/10 text-zowee-green border border-zowee-green/20">
                      Connected
                    </span>
                  )}
                </div>
                <p className="text-sm text-zowee-light/60 mb-4">
                ...
                {!alexaLinked ? (
                  <>
                    <div className="mb-4 p-3 rounded-lg bg-blue-500/5 border border-blue-500/15">
                      ...
                      <ul className="text-xs text-zowee-light/60 space-y-1">
                  ...
                  <div className="flex items-center gap-3">
                    <div className="flex-1 p-3 rounded-lg bg-zowee-green/5 border border-zowee-green/15">
                      <p className="text-xs text-zowee-green/80">
                        ✓ Your Alexa account is connected. Text Zowee to control your devices!
                      </p>
                    </div>
                    <button
                      onClick={unlinkAlexa}
                      disabled={loading}
                      className="px-4 py-2 rounded-lg text-xs font-semibold bg-white/5 border border-white/10 text-zowee-light/60 hover:bg-red-500/10 hover:border-red-500/30 hover:text-red-400 transition-all disabled:opacity-50"
                    >
                      Unlink
                    </button>
                  </div>
          ...
          <div className="rounded-2xl p-6 bg-white/2 border border-white/5">
            <h3 className="font-heading font-bold text-base text-zowee-light mb-3">
            ...
            <div className="grid grid-cols-2 gap-3">
              <div className="p-3 rounded-lg bg-white/2 border border-white/5 opacity-50">
                <div className="flex items-center gap-2 mb-1">
                  ...
                  <span className="text-sm font-semibold text-zowee-light">Google Home</span>
                </div>
                <p className="text-xs text-zowee-light/40">Smart home control</p>
              </div>
              <div className="p-3 rounded-lg bg-white/2 border border-white/5 opacity-50">
                <div className="flex items-center gap-2 mb-1">
                  <span className="text-lg">🎵</span>
                  <span className="text-sm font-semibold text-zowee-light">Spotify</span>
                </div>
                <p className="text-xs text-zowee-light/40">Music control</p>
              </div>
              <div className="p-3 rounded-lg bg-white/2 border border-white/5 opacity-50">
                <div className="flex items-center gap-2 mb-1">
                  <span className="text-lg">📅</span>
                  <span className="text-sm font-semibold text-zowee-light">Google Calendar</span>
                </div>
                <p className="text-xs text-zowee-light/40">Calendar management</p>
              </div>
              <div className="p-3 rounded-lg bg-white/2 border border-white/5 opacity-50">
                <div className="flex items-center gap-2 mb-1">
                  <span className="text-lg">🚗</span>
                  <span className="text-sm font-semibold text-zowee-light">Tesla</span>
                </div>
                <p className="text-xs text-zowee-light/40">Car control</p>
              </div>
            </div>
          </div>
        </div>
