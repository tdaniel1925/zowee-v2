  ...
  const faqs = [
    {
      ...
      answer:
        'Yes. Regular text message (SMS) on any phone. No smartphone required. If you can send a text, you can use Zowee.',
    },
    {
      question: 'What can Zowee actually do?',
      answer:
    ...
    },
    {
      ...
      answer:
        'Zowee tells you honestly and suggests an alternative. You can also text "I wish you could [thing]" to suggest a new skill.',
    },
    {
    ...
    },
    {
      ...
      answer: 'Text CANCEL to your Zowee number. Done. No forms, no phone calls, no hassle.',
    },
  ]
        ...
        <div className="space-y-4">
          {faqs.map((faq, i) => (
            ...
            >
              ...
              >
                <span className="font-display font-semibold text-zowee-light pr-8">
                  {faq.question}
                </span>
                <span
                  className="text-zowee-green text-2xl transition-transform flex-shrink-0"
                  style={{
              ...
              >
                <div className="px-6 pb-4 text-zowee-muted-2 leading-relaxed">
                  {faq.answer}
                </div>
              </div>
            </div>
