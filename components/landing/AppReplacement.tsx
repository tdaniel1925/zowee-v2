    ...
    <section className="py-12 relative overflow-hidden" id="how-it-works">
      <div className="max-w-6xl mx-auto px-4">
        ...
        <div className="text-center mb-16">
          ...
          >
            One text. <span className="text-jordyn-green">Everything handled.</span>
          </h2>
          <p className="text-lg text-jordyn-muted-2 max-w-2xl mx-auto">
            Stop juggling dozens of apps. Jordyn. replaces them all with simple text messages.
          </p>
        </div>
          ...
          <div className="relative">
            ...
            >
              <div className="flex items-center gap-2 mb-6">
                ...
                <h3 className="font-display font-bold text-xl text-jordyn-light">The old way</h3>
              </div>
              ...
              <div className="grid grid-cols-2 gap-3">
                {oldApps.map((app, i) => (
                  ...
                  >
                    ...
                    <span className="text-sm text-jordyn-muted" style={{ textDecoration: 'line-through' }}>
                      {app}
                    </span>
                  </div>
                ))}
              ...
              <p className="text-xs text-jordyn-muted mt-4 text-center">...and 47 more apps</p>
            </div>
          </div>

          {/* RIGHT: The Jordyn. way */}
          <div className="relative">
            <div
            ...
            >
              ...
              <div className="relative z-10">
                <div className="flex items-center gap-2 mb-6">
                  <span className="text-2xl">💬</span>
                  <h3 className="font-display font-bold text-xl text-jordyn-light">The Jordyn. way</h3>
                </div>
                ...
                <p className="text-sm text-jordyn-green font-semibold mt-6 text-center">
